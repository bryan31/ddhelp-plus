...
public class Api {
    ...
    public Map<String, Map<String, Object>> context = new ConcurrentHashMap<>();

    public Invocable invocable;

    public boolean jdk8Warning = false;

    public Api(UserConfig userConfig) {
    ...
    private Map sign(Map body) {
        ...
        try {
            if (invocable == null) {
                ...
                engine.eval(FileUtil.readString(new File(FileUtil.getAbsolutePath("sign.js")), "UTF-8"));
...
//    @SneakyThrows 不少人没有安装lombok插件 还是用传统的try catch吧
     ...
     * @return 是否成功
     */
    private boolean isSuccess(JSONObject object, String actionName) {
        ...
        try {
            ...
            for (int i = 0; i < validAddress.size(); i++) {
                ...
                if (address.getBool("is_default")) {
                    ...
                    checkVO.setStationId(stationInfo.getStr("id"));
                    checkVO.setAddressId(address.getStr("id"));
                    return checkVO;
                }
            }
        } catch (Exception e) {
     ...
     * @return 购物车信息
     */
    public Map<String, Object> getCart(boolean noProductsContinue) {
        try {
     ...
     * @return 配送信息
     */
    public Map<String, Object> getMultiReserveTime(String addressId, Map<String, Object> cartMap) {
        try {
     ...
     * @return 订单确认信息
     */
    public Map<String, Object> getCheckOrder(String addressId, Map<String, Object> cartMap, Map<String, Object> multiReserveTimeMap) {
        try {
     ...
     */
    public boolean addNewOrder(String addressId, Map<String, Object> cartMap, Map<String, Object> multiReserveTimeMap, Map<String, Object> checkOrderMap) {
        try {
